        ...
        <div className="container mx-auto px-4 py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
              Clínica especializada en cirugía maxilofacial y estética facial. Seguridad médica y atención personalizada de la Dra. Luz María López Saavedra. Maxilofacial Hermosillo
            </p>
      ...
      <section className="container mx-auto px-4 py-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-1 lg:order-2 space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            En Face Clinic ofrecemos atención especializada en cirugía maxilofacial, integrando diagnóstico, funcionalidad y armonía facial en cada tratamiento. Nuestro enfoque personalizado busca mejorar tanto la salud como la estética del paciente, brindando resultados buenos y seguros.
          </p>
